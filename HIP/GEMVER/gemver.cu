		...
		DATA_TYPE POLYBENCH_1D(z,N,n))
{
	...
	hipLaunchKernelGGL(gemver_kernel1, grid1, block1 , 0, 0, n, alpha, beta, A_gpu,v1_gpu,v2_gpu, u1_gpu, u2_gpu);
	hipDeviceSynchronize();
	hipLaunchKernelGGL(gemver_kernel2, grid2, block2 , 0, 0, n, alpha, beta, A_gpu,x_gpu,y_gpu, z_gpu);
	hipDeviceSynchronize();
	hipLaunchKernelGGL(gemver_kernel3, grid3, block3 , 0, 0, n, alpha, beta, A_gpu,x_gpu,w_gpu);
	hipDeviceSynchronize();
