		...
		DATA_TYPE POLYBENCH_2D(G_outputFromGpu,NI,NL,ni,nl))
{
	...
	hipLaunchKernelGGL(mm3_kernel1, grid1, block, 0, 0, ni, nj, nk, nl, nm, A_gpu, B_gpu, E_gpu);
	hipDeviceSynchronize();
	hipLaunchKernelGGL(mm3_kernel2, grid2, block, 0, 0, ni, nj, nk, nl, nm, C_gpu, D_gpu, F_gpu);
	hipDeviceSynchronize();
	hipLaunchKernelGGL(mm3_kernel3, grid3, block, 0, 0, ni, nj, nk, nl, nm, E_gpu, F_gpu, G_gpu);
	hipDeviceSynchronize();
